...
if ($name == "") {
    ...
    $headers .= 'From:  Papr <ahadulislam49@gmail.com>' . "\r\n";
    $headers .= 'cc: ahadulislam49@gmail.com' . "\r\n";
    $headers .= 'bcc: ahadulislam49@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f ahadulislam49@gmail.com');
